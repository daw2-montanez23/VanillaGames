//importamos la funcion ls del archivo funciones
import {ls} from '../componentes/funciones.js'
import { menuUsuario, menuRol } from './menu.js'
export const header = {
    template: // html
    `
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#/">TOP 5 proyectos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#">A cerca de</a>
          </li>
        </ul>
        <!--Aqui va el Menu rol -->
        <div id="menuRol"></div>
    ...
    script: ()=>{
      ...
      // Simulamos el inicio de sesión de un usuario
       ls.setUsuario({ email: 'chafardera@gmial.com', rol: 'anonimo' })
